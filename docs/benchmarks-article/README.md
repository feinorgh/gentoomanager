...
The workflow `.github/workflows/quarto-pages.yml` renders this project and deploys the
`docs/benchmarks-article/_site` output through GitHub Pages from the `gh-pages-build` branch.
